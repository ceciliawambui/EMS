...
@endif
@if($trashed == 1)
<a href="{{ route('jobtitles.forceDelete',$id) }}" data-toggle="tooltip" data-original-title="Delete" class="delete btn btn-danger">
    Delete
</a>
<a href="{{ route('jobtitles.restore',$id) }}" data-id="{{ $id }}" data-toggle="tooltip" data-original-title="Restore" class="btn btn-warning">
    Restore
</a>
@endif