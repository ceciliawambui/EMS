@if($trashed == 0)
<a href="{{ route('department.edit',$id) }}" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-primary edit btn-xs">
    Edit
</a>
...
<a href="{{ route('department.restore',$id) }}" data-id="{{ $id }}" data-toggle="tooltip" data-original-title="Restore" class="btn btn-warning btn-xs">
    Restore
</a>
@endif
