...
@if($trashed == 0)
<a href="{{ route('department.edit',$id) }}" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-primary edit btn-sm">
    Edit
</a>
...
@endif
@if($trashed == 1)
<a href="{{ route('department.forceDelete',$id) }}" data-toggle="tooltip" data-original-title="Delete" class="delete btn btn-danger btn-sm">
    Delete
</a>
<a href="{{ route('department.restore',$id) }}" data-id="{{ $id }}" data-toggle="tooltip" data-original-title="Restore" class="btn btn-warning btn-sm">
    Restore
</a>
@endif
